                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <?php $query = $connection->query("SELECT * FROM kategori_penilaian"); while ($row = $query->fetch_assoc()): ?>
                              <li><a href="?page=perhitungan&kategori_penilaian=<?=$row["id_penilaian"]?>"><?=$row["jenis_penilaian"]?></a></li>
                            <?php endwhile; ?>
                          </ul>
                        </li>
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="?page=kategori_penilaian">Data Penilaian</a></li>
                            <li class="divider"></li>
